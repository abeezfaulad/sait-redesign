...
export const NOTICE = {
  text: 'Registrations for HackIT 2026 close 28 September — apply before the deadline.',
  href: '#events',
}

export const STATS = [
  { value: '480', suffix: '+', key: 'Active members' },
  { value: '32', suffix: '', key: 'Events this year' },
  { value: '61', suffix: '', key: 'Recruiting companies' },
  { value: '2400', suffix: '+', key: 'Alumni network' },
]
...
export const FACULTY = [
  ...
  { name: 'Dr. Lakshmi Iyer', role: 'Faculty, Research', initials: 'LI' },
]
...
export const UPCOMING_EVENTS = [
  ...
  { date: '22 Oct 2026', title: 'Design Systems Workshop', category: 'Workshop', venue: 'Seminar Hall, IT Block', time: '15:00', note: 'Hands-on. Bring your laptop.' },
  { date: '05 Nov 2026', title: 'Annual Day & Department Awards', category: 'Cultural', venue: 'Main Auditorium, SOE', time: '18:00', note: 'Formal. All students welcome.' },
]
...
export const PAST_EVENTS = [
  ...
  { date: 'Feb 2026', title: 'Annual Day & Department Awards', category: 'Cultural' },
  { date: 'Dec 2025', title: 'Workshop: Git & Collaborative Development', category: 'Workshop' },
...
export const PLACEMENT_STATS = [
  { value: '94', suffix: '%', key: 'Placement rate, 2026 batch' },
  { value: '44', prefix: '₹', suffix: ' LPA', key: 'Highest package' },
  { value: '9.2', prefix: '₹', suffix: ' LPA', key: 'Median package' },
  { value: '61', suffix: '', key: 'Recruiters on campus' },
]
...
export const CAREER_RESOURCES = [
  ...
  { label: 'Internship policy & guidelines', href: '#' },
...
export const ALUMNI = [
  ...
  { name: 'Kiran Das', year: '2012', role: 'CTO, Techfork', note: 'Engineering leadership at Kochi SaaS.' },
  { name: 'Aparna Menon', year: '2020', role: 'Data Engineer, Swiggy', note: 'Streaming infrastructure.' },
]

export const ACHIEVEMENTS = [
  { year: '2026', title: 'Winners, Smart India Hackathon (Software)', who: 'Team of 6, 3rd year IT' },
  ...
  { year: '2024', title: 'Published: Springer LNNS, Applied ML', who: 'Final-year project group' },
  { year: '2024', title: 'Best Paper, National Conference on Computing', who: 'R. Kurup, M. Pillai' },
]
...
export const SEED_ACTIVITIES = [
  { id: 1, title: 'HackIT 2025 — 1st place', type: 'hackathon', date: '2025-03-12', role: 'Team lead', status: 'verified', points: 50, who: 'Aravind K.' },
  { id: 2, title: 'IEEE CONECCT — Best Paper', type: 'publication', date: '2026-02-04', role: 'Co-author', status: 'verified', points: 35, who: 'Aditya M.' },
  { id: 3, title: 'Summer Internship — Zoho', type: 'internship', date: '2025-06-01', role: 'Intern, Backend', status: 'verified', points: 30, who: 'Meenakshi P.' },
  { id: 4, title: 'Intro to Kubernetes Workshop', type: 'workshop', date: '2026-07-22', role: 'Participant', status: 'pending', points: 15, who: 'Rohan V.' },
  { id: 5, title: 'Kerala State Hackathon — 1st place', type: 'hackathon', date: '2025-11-18', role: 'Team member', status: 'verified', points: 50, who: 'Fathima R.' },
]
